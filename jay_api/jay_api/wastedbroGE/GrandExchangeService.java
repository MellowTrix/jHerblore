package scripts.jay_api.wastedbroGE;

import scripts.jay_api.wastedbroGE.grand_exchange_api.GrandExchangePriceService;
import scripts.jay_api.wastedbroGE.rsbuddy.RsBuddyPriceService;
 ...
 */
public class GrandExchangeService extends org.tribot.api2007.GrandExchange
{
    ...
    private static IRsItemPriceService GEService = new RsItemPriceService.Builder()
    		.addPriceService(new GrandExchangePriceService())
            .build();
    ...
    public static Optional<Integer> tryGetPrice_GE(int itemId)
    { 	
        return GEService.tryGetPrice(itemId);
    }
